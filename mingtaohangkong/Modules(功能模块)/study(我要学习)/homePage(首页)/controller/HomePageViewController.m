...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, kTopHeight, KScreenWidth, KScreenHeight-kTopHeight-kTabBarHeight) collectionViewLayout:layout];
